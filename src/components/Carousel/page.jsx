  ...
  return (
    <>
      <div className="text-color-primary">
        ...
        >
          {randomAnime?.data?.map((anime, index) => (
              ...
              <div className="absolute inset-0 p-4 bg-black bg-opacity-40 text-white">
                <div className="flex items-center justify-evenly bg-no">
                  <div className="px-2 mx-5">
                    ...
                    <a
                      className="inline-flex items-center gap-2 rounded-lg border border-color-secondary bg-color-hut2 px-8 py-3 text-white hover:bg-color-accent hover:text-color-primary focus:outline-none focus:ring active:text-color-accent"
